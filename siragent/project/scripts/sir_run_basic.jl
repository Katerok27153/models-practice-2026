...
plot!(p, agent_df.time, agent_df.infected, label = "Инфицированные")
plot!(p, agent_df.time, agent_df.recovered, label = "Выздоровевшие")
plot!(p, agent_df.time, model_df.total, label = "Всего (включая умерших)", linestyle = :dash)
